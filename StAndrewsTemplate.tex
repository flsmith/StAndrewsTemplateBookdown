...
\addcontentsline{toc}{section}{Lateness policy}
...
\addcontentsline{toc}{section}{Work submitted late for good reason}
...
\addcontentsline{toc}{subsection}{Markdown files}
...
\addcontentsline{toc}{subsection}{YAML files}
...
\addcontentsline{toc}{subsection}{LaTeX files}
...
\addcontentsline{toc}{subsection}{Bibliography files}
...
\addcontentsline{toc}{subsection}{Web files}
...
\addcontentsline{toc}{subsection}{Hidden files}
...
\begin{center}\includegraphics{StAndrewsTemplate_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{StAndrewsTemplate_files/figure-latex/unnamed-chunk-23-1} \end{center}
